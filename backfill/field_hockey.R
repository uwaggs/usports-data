...
for(league in leagues) {
  ...
  for(link in links) {
    ...
    team_box <- usportsscraper::scrape_fh_team_box_score_safe(html = webpage) |> add_info(link)
    player_box <- usportsscraper::scrape_fh_player_box_score_safe(html = webpage) |> add_info(link)
    pbp <- usportsscraper::scrape_fh_play_by_play_safe(html = webpage) |> add_info(link)
